...
namespace NeinTile.Editions.Tests
{
    public class InsanityTilesAreaMergerTest
    {
        public static TheoryData CanMergeData
            ...
            {
                { new TileInfo(0, 100), new TileInfo(0, 50), true },
                { new TileInfo(0, 50), new TileInfo(0, 100), true },
                ...
                { new TileInfo(-3, 3), new TileInfo(-3, 3), true },
                { new TileInfo(-3, 3), new TileInfo(-6, 6), false },

                { new TileInfo(1, 0), new TileInfo(-2, 0), false },
                { new TileInfo(2, 0), new TileInfo(-1, 0), false },
                { new TileInfo(-1, 0), new TileInfo(2, 0), false },
                { new TileInfo(-2, 0), new TileInfo(1, 0), false },
                { new TileInfo(3, 3), new TileInfo(-3, 3), false },
                { new TileInfo(-3, 3), new TileInfo(3, 3), false },
            };
